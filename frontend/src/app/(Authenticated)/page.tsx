...
export default function Home() {
  ...
  const [blogs, setBlogs] = useState(["nigga"]);
    ...
    <div className="h-full w-full flex flex-row items-start gap-[3px] bg-[#1F1F1F] border border-white/10 rounded-xl overflow-x-hidden">
      <div className="flex w-full flex-col items-start gap-[1px] rounded-xl text-white">
        ...
        {blogs.map((blog, index) => (
          <div
            className="flex md:flex-col justify-between w-full items-center p-6 gap-[28px] bg-[#0D0D0D]"
            key={index}
          >
            <div className="flex w-full flex-col gap-2">
              ...
              <div className="flex align-center gap-3 items-center">
                ...
                <p className="text-14 font-medium text-white-200">
                  {user?.name}
                </p>
              </div>
                ...
                <div className="flex flex-col items-start gap-1">
                  ...
                  <div className="flex flex-col items-start gap-1">
                    ...
                    <h6 className="text-14 text-white-100">
                      So basically your dad is gonna get cucked by a fkin sex
                      toy ai robot ohh sorry my bad you DONT FKIN HAVE A DADA
                      HAHAHAH YOU FKIN LOOSERR!
                    </h6>
                  </div>
