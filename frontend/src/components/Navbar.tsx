  ...
  return (
    <div className="flex justify-between items-center py-2 px-3 md:py-3 md:px-6 bg-[#0D0D0D] rounded-[2px] gap-2 md:gap-4">
      ...
      <div className="flex items-center gap-3 md:gap-3 flex-shrink-0">
        ...
        <Link href="/write">
          <button
            className="flex items-center justify-center h-9 md:h-10 px-3 md:px-6 gap-1 md:gap-3 bg-[#191919] border border-white/10 rounded-full shadow-[0_4px_4px_rgba(0,0,0,0.27),inset_0_1px_4px_-2px_rgba(235,235,235,0.12)] text-14 md:text-16 text-white-300 hover:bg-grey-800 transition-colors duration-100 ease-out"
          >
