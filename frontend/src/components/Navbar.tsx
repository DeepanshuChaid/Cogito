...
export default function Navbar () {
  ...
  return (
    <div className="flex justify-between items-center py-3 px-6 bg-[#0D0D0D] rounded-[2px]">
        ...
        <svg onClick={toggleSidebar} className="text-white-400 hover:text-white  hover:bg-black-50" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
