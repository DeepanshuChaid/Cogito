...
export default function Navbar () {
  return (
    <div className="flex justify-between items-center py-3 px-6 bg-[#0D0D0D] rounded-[2px]">
      ...
      <button
        className="flex items-center justify-center px-5 py-2 gap-3  bg-[#191919]  border border-white/10 rounded-full shadow-[0_4px_4px_rgba(0,0,0,0.27),inset_0_1px_4px_-2px_rgba(235,235,235,0.12)] text-16 text-white-300 hover:bg-black-50 transition-colors duration-200  ease-out"
      >
